...
export const LABEL_COMPLETED_SEARCH_PLACEHOLDER = 'Search tasks...';
export const LABEL_COMPLETED_SEARCH_ARIA = 'Search completed tasks by title';
...
export const LABEL_TITLE_CHAR_COUNTER_ARIA = 'Title character count';
