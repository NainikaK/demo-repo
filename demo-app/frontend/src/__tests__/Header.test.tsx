...
describe('Header', () => {
  it('render test - renders the Task Manager title with the correct color class', () => {
    mocks.theme = 'light';
    render(<Header />);
  ...
  it('edge case - renders the Task Manager title with text-[#AFEEEE] class in dark theme', () => {
    mocks.theme = 'dark';
    render(<Header />);
