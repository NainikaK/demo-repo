...
-  AddTasksSection render test - renders the section heading and chevron button in the expanded state by default
-  AddTasksSection interaction test - clicking the chevron button collapses the section and clicking again expands it
-  AddTasksSection edge case - clicking the title text does not collapse the section
