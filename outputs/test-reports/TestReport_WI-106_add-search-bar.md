# Test Results — Work Item 106

_Generated: 2026-06-05 06:04 UTC_
...
-  CompletedTasksSection search bar renders a search bar in the Completed Tasks section
-  CompletedTasksSection search bar shows all completed tasks when search term is empty
-  CompletedTasksSection search bar filters tasks in real time as the user types
-  CompletedTasksSection search bar hides tasks whose titles do not match the search input
-  CompletedTasksSection search bar restores the full list when the search bar is cleared
-  CompletedTasksSection search bar performs case-insensitive filtering
...
-  useCompletedTaskSearch filters tasks by title in a case-insensitive manner when a search term is set
-  useCompletedTaskSearch returns all tasks when search term is cleared after being set
